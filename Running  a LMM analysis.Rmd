...
creates a funstion to divide mean by standard dev.
...
not so much, expecially toward the negative end
...
changes only one part of a line of code that you want ran for the data and to make multiple data frames
...
sum sq helps estimate the amount of correlation between the data
